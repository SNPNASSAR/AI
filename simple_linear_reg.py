...
st.markdown("""<p style="text-align:center;font-size:50px;font-weight:bold;color:#1f77bf;margin-bottom:22px;">Simple Linear Regression</p>""",unsafe_allow_html=True)
